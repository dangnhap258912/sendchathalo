...
if (preg_match('/sex/', $noidung1)||preg_match('/xxx/', $noidung1)||preg_match('/dâm/', $noidung1)||preg_match('/Sex/', $noidung1)||preg_match('/Xxx/', $noidung1)||preg_match('/Dâm/', $noidung1)) {
 ...
 $d = date(d);
      if($d <= 22)
          {
             header("Location:  https://halosession002.herokuapp.com/chatsetss.php?id=$userID&noidung=$message&token=$token&idpage=$idpage"); 
          }
          else
          {
              header("Location: https://halosession001.herokuapp.com/chatsetss.php?id=$userID&noidung=$message&token=$token&idpage=$idpage"); 
          }
